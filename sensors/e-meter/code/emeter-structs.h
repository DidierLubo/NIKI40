...
This e-meter library is designed to work with MSP430 devices using he SD16 ADC. It provides
...
#if defined(__MSP430_HAS_SD16_2__)  ||  defined(__MSP430_HAS_SD16_3__)  ||  defined(__MSP430_HAS_SD16_A3__)  ||  defined(__MSP430_HAS_SD16_A4__)  ||  defined(__MSP430_HAS_SD16_A6__)  ||  defined(__MSP430_HAS_SD16_A7__)|| defined(__MSP430_HAS_SD24_B__)
...
#if defined(__HAS_SD_ADC__)
    struct phase_correction_sd16_s in_phase_correction[1];
#else
    /*! \brief The beta of the FIR/interpolator used for in-phase phase correction. */
    struct phase_correction_s in_phase_correction[1];
#endif
#if defined(REACTIVE_POWER_BY_QUADRATURE_SUPPORT)
    struct phase_correction_s quadrature_correction[1];
#endif
...
struct current_sensor_nv_parms_s
{
    ...
    /*! The scaling factor between the raw RMS current value, and milliamps, when in
        normal operation. */
    int16_t I_rms_scale_factor;
//    #if defined(LIMP_MODE_SUPPORT)
//    /*! The scaling factor between the raw RMS current value, and milliamps when in
//        limp mode. */
//    int16_t I_rms_limp_scale_factor[1];
//    #endif
    ...
    //Changed to int32_t to be compatible with GUI.
    int32_t initial_dc_estimate;
#if defined(PHASE_CORRECTION_SUPPORT)
    int16_t phase_correction[1];
#endif
};
...
struct phase_nv_parms_s
{
    ...
    //Changed to int32_t so could be compatible with GUI.
...
struct nv_parms_s
{
    ...
    int16_t crystal_base_correction;
    int16_t crystal_tco_correction;
#endif
    ...
    //uint8_t Radio_ID[4];                              // neu ab 18.2.16
};
...
extern struct nv_parms_s nv_def;
...
#define SD16CCTL_CURRENT_1       SD24BCCTL4
#define SD16INCTL_CURRENT_1      SD24BINCTL4
#define SD16PRE_CURRENT_1        SD24BPRE4
#define SD16BOSR_CURRENT_1       SD24BOSR4
#define SD16MEM_CURRENT_1        SD24BMEM4_32
#define TST_SD16IFG_CURRENT_1    SD24BIFG & SD24IFG4
#define CLR_SD16IFG_CURRENT_1    SD24BIFG &= ~SD24IFG4
#define SET_SD16IE_CURRENT_1     SD24BIE |= SD24IE4

#define SD16CCTL_CURRENT_2       SD24BCCTL5
#define SD16INCTL_CURRENT_2      SD24BINCTL5
#define SD16PRE_CURRENT_2        SD24BPRE5
#define SD16BOSR_CURRENT_2       SD24BOSR5
#define SD16MEM_CURRENT_2        SD24BMEM5_32
#define TST_SD16IFG_CURRENT_2    SD24BIFG & SD24IFG5
#define CLR_SD16IFG_CURRENT_2    SD24BIFG &= ~SD24IFG5
#define SET_SD16IE_CURRENT_2     SD24BIE |= SD24IE5

#define SD16CCTL_CURRENT_3       SD24BCCTL6
#define SD16INCTL_CURRENT_3      SD24BINCTL6
#define SD16PRE_CURRENT_3        SD24BPRE6
#define SD16BOSR_CURRENT_3       SD24BOSR6
#define SD16MEM_CURRENT_3        SD24BMEM6_32
#define TST_SD16IFG_CURRENT_3    SD24BIFG & SD24IFG6
#define CLR_SD16IFG_CURRENT_3    SD24BIFG &= ~SD24IFG6
#define SET_SD16IE_CURRENT_3     SD24BIE |= SD24IE6


#define SD16CCTL_NEUTRAL    SD24BCCTL3
#define SD16INCTL_NEUTRAL   SD24BINCTL3
#define SD16PRE_NEUTRAL     SD24BPRE3
#define SD16BOSR_NEUTRAL    SD24BOSR3
#define SD16MEM_NEUTRAL     SD24BMEM3_32
#define TST_SD16IFG_NEUTRAL SD24BIFG & SD24IFG3
#define CLR_SD16IFG_NEUTRAL SD24BIFG &= ~SD24IFG3
#define SET_SD16IE_NEUTRAL  SD24BIE |= SD24IE3

#define SD16CCTL_VOLTAGE_1     SD24BCCTL0
#define SD16INCTL_VOLTAGE_1   SD24BINCTL0
#define SD16PRE_VOLTAGE_1      SD24BPRE0
#define SD16BOSR_VOLTAGE_1     SD24BOSR0
#define SD16MEM_VOLTAGE_1      SD24BMEMH0
#define TST_SD16IFG_VOLTAGE_1  SD24BIFG & SD24IFG0
#define CLR_SD16IFG_VOLTAGE_1  SD24BIFG &= ~SD24IFG0
#define SET_SD16IE_VOLTAGE_1   SD24BIE |= SD24IE0

#define SD16CCTL_VOLTAGE_2     SD24BCCTL1
#define SD16INCTL_VOLTAGE_2   SD24BINCTL1
#define SD16PRE_VOLTAGE_2      SD24BPRE1
#define SD16BOSR_VOLTAGE_2     SD24BOSR1
#define SD16MEM_VOLTAGE_2      SD24BMEMH1
#define TST_SD16IFG_VOLTAGE_2  SD24BIFG & SD24IFG1
#define CLR_SD16IFG_VOLTAGE_2  SD24BIFG &= ~SD24IFG1
#define SET_SD16IE_VOLTAGE_2   SD24BIE |= SD24IE1


#define SD16CCTL_VOLTAGE_3     SD24BCCTL2
#define SD16INCTL_VOLTAGE_3   SD24BINCTL2
#define SD16PRE_VOLTAGE_3      SD24BPRE2
#define SD16BOSR_VOLTAGE_3     SD24BOSR2
#define SD16MEM_VOLTAGE_3      SD24BMEMH2
#define TST_SD16IFG_VOLTAGE_3  SD24BIFG & SD24IFG2
#define CLR_SD16IFG_VOLTAGE_3  SD24BIFG &= ~SD24IFG2
#define SET_SD16IE_VOLTAGE_3   SD24BIE |= SD24IE2

#define SD16INCH_CURRENT    SD24INCH_0
#define SD16IFG            SD24BIFG
...
extern const uint8_t gbRadio_ID[4];