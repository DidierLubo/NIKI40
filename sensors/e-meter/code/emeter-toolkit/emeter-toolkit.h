...
#else
#define MPY32_BASE2  0x140
#endif

#define MPY32_              (MPY32_BASE2 + 0)    /* Multiply Unsigned Operand 1 */
#if !defined(__IAR_SYSTEMS_ICC__)
DEFL(   MPY32             , MPY32_)
#else
__no_init union
...
#define MPYS32_             (MPY32_BASE2 + 4)    /* Multiply Signed Operand 1 */
#if !defined(__IAR_SYSTEMS_ICC__)
DEFL(   MPYS32            , MPYS32_)
#else
__no_init union
...
#define MAC32_              (MPY32_BASE2 + 8)    /* MAC Unsigned Operand 1 */
#if !defined(__IAR_SYSTEMS_ICC__)
DEFL(   MAC32             , MAC32_)
#else
__no_init union
...
#define MACS32_             (MPY32_BASE2 + 12)   /* MAC Signed Operand 1 */
#if !defined(__IAR_SYSTEMS_ICC__)
DEFL(   MACS32            , MACS32_)
#else
__no_init union
...
#define OP2_32_             (MPY32_BASE2 + 16)   /* Operand 2 */
#if !defined(__IAR_SYSTEMS_ICC__)
DEFL(   OP2_32            , OP2_32_)
#else
__no_init union
...
#define RES64_              (MPY32_BASE2 + 20)   /* 32x32 bit result */
#if !defined(__IAR_SYSTEMS_ICC__)
DEFLL(  RES64             , RES64_)
#else
__no_init union
...
#if !defined(__IAR_SYSTEMS_ICC__)
DEFL(   SD24BMEM3_32      , SD24BMEM0_32_)
#else
__no_init union
{
  DEFXC                               SD24BMEM3_8[4];
...
#if !defined(__IAR_SYSTEMS_ICC__)
DEFL(   SD24BMEM5_32      , SD24BMEM2_32_)
#else
__no_init union
{
  DEFXC                               SD24BMEM5_8[4];
...
#if !defined(__IAR_SYSTEMS_ICC__)
DEFL(   SD24BMEM6_32      , SD24BMEM2_32_)
#else
__no_init union
{
  DEFXC                               SD24BMEM6_8[4];
...
#define __inline__ inline
#define __uninitialized__ __no_init
#endif
...
*/
extern uint32_t isqrt32(int32_t x);
