...
#define DC3 0x13
#define ACK 0x06
//#define NAK 0x15                                   Wegen USB-Modul
...
//------------------------------------------------------------------------------------------------------------------------
extern void UART_Put_Record(ST_UART_t* st, void *pvData, uint16_t uiLen);
...
//  ST_UART_t* st:    Der bei Init zurückgegebene Pointer
//------------------------------------------------------------------------------------------------------------------------
extern BYTE UART_Get_RXD_Anzahl(ST_UART_t* st);       // Gibt Anzahl der Zeichen im Empfangsbuffer zurück
...
//  ST_UART_t* st:    Der bei Init zurückgegebene Pointer
//------------------------------------------------------------------------------------------------------------------------
extern void URAT_SetStandardOut(ST_UART_t* st);
