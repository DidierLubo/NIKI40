...
// hier ist eine Hardware-Abhängigkeit: neu=1 alte Hardware 2
#define RADIO_UART_INDEX         1                      // 25.10.17: Auf UART UCA1 gelegt

#define RADIO_UART_BAUDRATE      BR115200
//#define RADIO_UART_BAUDRATE      BR57600

//==============================================================================================================================================
//    Define für UART-Radio      EIS_LWM2M_V2.0>
//==============================================================================================================================================
#define UCA1_USED
#define UCA1_LPM                 LPM3
#define UCA1_LPM_EXIT            LPM3_EXIT
#define UCA1_CLK_Source          SMCLK
#define UCA1_BAUDRATE_CLK        SMCLK_FREQ

#define UCA1_S_Buffer_len        RADIO_TX_BUF_LEN
#define UCA1_E_Buffer_len        RADIO_RX_BUF_LEN

////==============================================================================================================================================
////    Define für UART-Radio     EIS_LWM2M
////==============================================================================================================================================
//#define UCA2_USED
