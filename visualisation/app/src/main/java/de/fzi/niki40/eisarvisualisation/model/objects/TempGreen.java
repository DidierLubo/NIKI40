 ...
 * Class implementing the visualisation object TempGreen - used for live data visualisation of Temp
 */
...
public class TempGreen {
    ...
    public TempGreen(float size) {
        this(size, 0.0F, 0.0F, 0.0F);
    }

    public TempGreen(float size, float x, float y, float z) {
