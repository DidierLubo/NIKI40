...
/**
 * Created by FZI Forschungszentrum Informatik on 04.05.2018.
 * Class implementing the visualisation object YellowPrism - used for live data visualisation of Emeter power
 */

public class YellowPrism {
    ...
    public YellowPrism(float size) {
        this(size, 0.0F, 0.0F, 0.0F);
    }

    public YellowPrism(float size, float x, float y, float z) {
