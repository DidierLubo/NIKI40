 ...
 * Class implementing the visualisation object Temp Yellow - used for live data visualisation of Temp
 */
...
public class TempYellow {
    ...
    public TempYellow(float size) {
        this(size, 0.0F, 0.0F, 0.0F);
    }

    public TempYellow(float size, float x, float y, float z) {
