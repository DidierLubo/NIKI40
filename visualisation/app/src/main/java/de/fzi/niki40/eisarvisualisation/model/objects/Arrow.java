 ...
 * Class implementing the visualisation object Arrow - used for live data visualisation of wind flow
 */
...
public class Arrow {
    ...
    private void setArrays(float size, float x, float y, float z) {
        ...
        byte[] indices = new byte[]{
                ...
                (byte)1, (byte)4, (byte)0,
                (byte)0, (byte)4, (byte)3,
                (byte)3, (byte)4, (byte)2,
        };
    ...
    public void draw(GL10 unused) {
        ...
        GLES10.glDrawElements(4, 18, 5121, this.mIndexBuffer);//18 = number of triangles*3 = number of indices
