 ...
 * Class implementing the visualisation object TempRed - used for live data visualisation of Temp
 */
...
public class TempRed {
    ...
    public TempRed(float size) {
        this(size, 0.0F, 0.0F, 0.0F);
    }

    public TempRed(float size, float x, float y, float z) {
